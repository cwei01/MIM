...
from bert.sentiment_modeling import MIM
...
def run_train_epoch(args, global_step, model, param_optimizer,
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        batch_start_logits, batch_end_logits,batch_aspect_num, _ = model('extract_inference', input_mask, input_ids=input_ids, token_type_ids=segment_ids,
                                                                         window_size = args.window_size,logit_threshold = args.logit_threshold)
        ...
        loss = model('train', input_mask, input_ids=input_ids, token_type_ids=segment_ids,
                     ...
                     polarity_labels=labels, label_masks=label_masks,window_size = args.window_size,n_best_size = args.n_best_size, weight_kl =args.weight_kl, logit_threshold = args.logit_threshold)
    ...
    for batch in eval_dataloader:
        ...
        with torch.no_grad():
            batch_start_logits, batch_end_logits, batch_aspect_num,sequence_output = model('extract_inference', input_mask,
                                                                          input_ids=input_ids,
                                                                          token_type_ids=segment_ids, window_size = args.window_size,
...
def main():
    ...
    parser.add_argument("--output_dir", default='../results/base_Lap/test17', type=str)
    ...
    parser.add_argument("--warmup_proportion", default=0.1, type=float,
                        help="Proportion of training to perform linear learning rate warmup for. E.g., 0.1 = 10% "
                             "of training.")
    parser.add_argument("--save_proportion", default=0.8, type=float,
